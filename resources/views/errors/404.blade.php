...
.box div{
  ...
  -o-animation: moving 10s linear infinite;
...
<div class="info">
  follow me : 
  <a href="http://localhost:8000/admin" target="_blank">Home Admin</a>
  
  <a href="http://localhost:8000/user" target="_blank">Home User</a>
</div>
